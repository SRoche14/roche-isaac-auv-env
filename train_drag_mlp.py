...
def main():
    ...
    """
    # Parameters
    DATA_PATH = ['dragData.txt', 'dragData2.txt', 'dragData3.csv']  # CSV/TXT files
    INPUT_SIZE = 3
    OUTPUT_SIZE = 6
    BATCH_SIZE = 32
    EPOCHS = 500
    ...
    drag_mlp = DragMLP(DATA_PATH, INPUT_SIZE, OUTPUT_SIZE, BATCH_SIZE, EPOCHS, LEARNING_RATE, VAL_SIZE, TEST_SIZE)
    drag_mlp.train_mlp()
